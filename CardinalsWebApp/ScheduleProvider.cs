        ...
        static readonly Schedule rallySchedule = new Schedule(new PeriodBase[] {
            ...
            new Lunch(
                new LunchSlot("A Lunch / 4", 
                    ...
                    new Period("4B", new TimeOnly(12,50), new TimeOnly(13, 30))),
                new LunchSlot("4 / B Lunch",
                    new Period("4A", new TimeOnly(12, 10), new TimeOnly(12,50)),
        ...
        static readonly Schedule firstWeekSchedule = new Schedule(new PeriodBase[] {
            ...
            new Lunch(
                new LunchSlot("A Lunch / 4",
                    ...
                    new Period("4B", new TimeOnly(12,25), new TimeOnly(13, 10))),
                new LunchSlot("4 / B Lunch",
                    new Period("4A", new TimeOnly(11, 45), new TimeOnly(12,30)),
        ...
        static readonly Schedule tuesdayFriday = new Schedule(new PeriodBase[] {
            ...
            new Lunch(
                new LunchSlot("A Lunch / 4",
                    ...
                    new Period("4B", new TimeOnly(12, 05), new TimeOnly(12, 55))),
                new LunchSlot("4 / B Lunch",
                    new Period("4A", new TimeOnly(11, 25), new TimeOnly(12, 15)),
            ...
            [DayOfWeek.Wednesday] = new Schedule(new PeriodBase[] {
                ...
                new Lunch(
                    new LunchSlot("A Lunch / 4",
                        ...
                        new Period("4B", new TimeOnly(11, 20), new TimeOnly(12, 50))),
                    new LunchSlot("4 / B Lunch", 
                        new Period("4A", new TimeOnly(10, 40), new TimeOnly(12, 10)),
            ...
            [DayOfWeek.Thursday] = new Schedule(new PeriodBase[] {
                ...
                new Lunch(
                    new LunchSlot("A Lunch / 3",
                        ...
                        new Period("3B", new TimeOnly(11, 15), new TimeOnly(12, 40))),
                    new LunchSlot("3 / B Lunch",
                        new Period("3A", new TimeOnly(10, 35), new TimeOnly(12, 00)),
